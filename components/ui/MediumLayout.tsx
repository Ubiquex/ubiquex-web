  ...
  return (
    <section className="bg-ink">
      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-[30px] px-7 pt-8 pb-20 min-[860px]:grid-cols-2 min-[860px]:items-center min-[860px]:gap-[52px]">
         ...
         */}
        <div className={reverse ? "order-1 min-[860px]:order-2" : undefined}>
          {copy}
        </div>
        <div className={reverse ? "order-2 min-[860px]:order-1" : undefined}>
          {panel}
        </div>
      </div>
    </section>
...
export function MediumCopy({
  ...
  return (
    <>
      <span
        className={`mb-4 inline-block rounded-full border px-[10px] py-[4px] font-mono text-[10.5px] tracking-[0.08em] uppercase min-[860px]:mb-5 min-[860px]:px-[12px] min-[860px]:py-[5px] min-[860px]:text-[11.5px] ${accent.pill}`}
      >
        {eyebrow}
      </span>
